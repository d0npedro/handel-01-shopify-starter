...
export default async function ShopPage({ searchParams }: { searchParams: Promise<{ typ?: string }> }) {
  ...
  return (
    <section className="catalog-page">
      <header className="catalog-header"><div><p className="eyebrow">Katalog / Demo</p><h1>Ideen, die<br /><em>lieferbar</em> werden.</h1></div><p>Ein gemischter Katalog als Vorlage: echte Warenlogik für Versandprodukte und digitale Bereitstellung für Code, Audio und Apps.</p></header>
